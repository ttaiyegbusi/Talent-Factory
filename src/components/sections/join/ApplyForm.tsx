  ...
  return (
    ...
    >
      ...
      <p className="max-w-sm text-[14px] leading-[21px] text-[#3a3a3a]">
        We&apos;re reviewing your application. If it looks like a fit,
        we&apos;ll be in touch about testing next steps.
      </p>
    </motion.div>
  );
}
        ...
        <div className="rounded-2xl bg-white p-7 md:p-10">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <Field label="What's your specialty?">
              ...
              <Field label="Tell us about your experience (optional)">
                <textarea
                  name="details"
                  rows={4}
                  placeholder="What kind of work have you done, and what are you looking for?"
